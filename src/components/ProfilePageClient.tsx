...
import { getProfileByUser, getUserPosts, updateProfile } from "@/actions/profile.action";
...
export default function ProfilePageClient({
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      successToast(!isFollowing ? `You are now following ${user.name}` : `You are no longer following ${user.name}`);
    } catch (error) {
